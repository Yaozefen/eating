...
<html>
	<head>
        ...
        <script src="js/highchartShow.js"></script>
	...
	<body>
		<div class = "container">
			...
			<div id = "bread" class = "row">
				<ul class = "breadcrumb col-lg-10 col-lg-offset-1" style = "margin-top:1rem;">
					...
					<li>订单管理</li>
					<li class = "active"><a href = "${pageContext.request.contextPath }/queryTurn.action">十日营业额</a></li>
				</ul>
			</div>
			<article id = "main_article" >
					...
					<aside id = "main_aside">
				        ...
				        <div class="actions" id = "actions">
				            ...
				            <button class="switcher" id="column" id = "switcher">column</button>
		...
		<!-- 隐藏域组,用于获取action层营业额数据 -->
		<s:iterator var = "list" value = "list">
			<input type = "hidden" value = "<s:property value = '#list.date'/>" class = "value1" />
			<input type = "hidden" value = "<s:property value = '#list.turn'/>" class = "value2" />
		</s:iterator>
	</body>
</html>
