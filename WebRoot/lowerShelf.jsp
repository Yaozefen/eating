...
<html>
	<head>
		...
		<script type="text/javascript" src="js/lowerShelf.js" ></script>
	</head>
	<body>
		<div class = "container">
			...
			<div id = "bread" class = "row">
				<ul class = "breadcrumb col-lg-10 col-lg-offset-1" style = "margin-top:1rem;">
					...
					<li>菜品信息</li>
					<li class = "active"><a href = "${pageContext.request.contextPath }/lowerShelf.jsp">下架菜品</a></li>
				</ul>
			</div>
			<article id = "main_article" >
					...
					<aside id = "main_aside">
						<h2 class = "col-lg-12 text-center">菜品下架</h2>
						<form action = "${pageContext.request.contextPath }/dSearch.action" method = "post" class = "form-horizontal" role = "form" id = "quitform" name = "quitform">
							<div class = "form-group">
								<br />
								<div class="row" style = "margin-top:6rem;">
									<div class = "col-lg-5 col-lg-offset-2">
										<input class = "form-control" id = "content" name = "content" placeholder="请输入菜名或者类别进行搜索" >
									</div>
						...
						<!--响应式表格中每个表格项固定，太小会出现滚动条-->
							...
							<tbody>
									...
									<s:iterator var = "dish" value = "#request.dish" status="sta">
									<tr>
										
										<td><s:property value = "dish.dishName"/></td>
										<td><s:property value = "dish.type"/></td>
										<td><s:property value = "dish.price"/></td>
										<td><s:property value = "dish.dishImg"/></td>
										<td><s:property value = "dish.sales"/></td>
										<td><s:property value = "dish.introduction"/></td>
										<td>
											<a class = "btn btn-danger" href = "${pageContext.request.contextPath }/deleteDish.action?dish.dishName=<s:property value = 'dish.dishName'/>">移除</a>
										</td>
									</tr>
								</s:iterator>
							</tbody>
